    ...
    return [
        ...
        *[
        ...
        spec(
            ...
            parameters=[
                ("elementary rule", "one of rules 45, 30, or 60, including a selected conjugate or reflection"),
                ("n", "finite cyclic ring size"),
            ],
            variants=[
                ("base-rule presets", "rules 45, 30, and 60"),
                ("symmetry variants", "the conjugates and reflections of the three base rules"),
            ],
        ...
        spec(
            ...
            1,
            "constraint",
            [ev("U006511", "PROSE", "DIRECT_COMPLETE_MECHANICS", "The model set consists of n-by-n binary square grids containing no adjacent pair of black cells.", CONSTRAINT_FIELDS + ["parameters_and_variants"])],
            values={
        ...
        spec(
            ...
            2,
            "constraint",
            [ev("U006511", "PROSE", "DIRECT_IDENTITY", "The hard-hexagon lattice gas is named as a hexagonal-cell constraint model with a known entropy.", ["object_kind", "carrier", "result_kind", "parameters_and_variants"])],
            values={
        ...
        spec(
            ...
            3,
            "constraint",
            [ev("U006511", "PROSE", "DIRECT_COMPLETE_MECHANICS", "Accepted configurations are complete coverings of a square grid by two-cell dominoes.", CONSTRAINT_FIELDS + ["parameters_and_variants"])],
            values={
