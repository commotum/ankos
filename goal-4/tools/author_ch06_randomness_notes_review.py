        ...
        *[
        ...
        spec(
            ...
            values={
                ...
                "structural_invariants": "for rule 22, the one-step nonzero stable estimate is 1-1/Sqrt[3] approximately 0.42 versus actual 0.35095; the two-step estimate is 0.35012 and the three-step estimate is 0.379",
        ...
        spec(
            ...
            "ca1d",
            [
                ev("U006461", "FORMULA", "DIRECT_PARTIAL_MECHANICS", "The new cell is f[a1,a2], with f associative.", ["object_kind", "alphabet_or_value_schema", "read_dependencies_or_neighborhood", "law_kind", "rule_relation_constraint_function_or_probability_law", "structural_invariants", "parameters_and_variants"]),
        ...
        spec(
            ...
            parameters=[("net", "finite labeled sequence network supplied as the transform input")],
            aliases=["TrimNet"],
        ),
        spec(
            "regular language",
        ...
        spec(
            ...
            values={
                ...
                "structural_invariants": "h_t <= h_tx <= 2 lambda h_x and h <= 2r h_t; for additive rules 90 and 150, h_tx=2r=2",
        ...
        spec(
            ...
            values={
                ...
                "structural_invariants": "every node has exactly one outgoing arc; every component contains one recurrent cycle with possible transient trees; underlying spatial or color symmetries can produce repeated isomorphic components; for finite rule-60 and rule-90 graphs, odd n gives a single-arc rooted structure and half the states on cycles, while the general on-cycle fraction is 2^(-2^IntegerExponent[n,2]); single-black states are always on longest cycles and all-white is a length-1 cycle",
