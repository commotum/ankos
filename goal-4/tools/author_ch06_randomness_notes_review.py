...
def candidate_specs() -> list[dict[str, Any]]:
    ...
    return [
        ...
        *[
        ...
        spec(
            "larger-range embedding and edge-nearness relation for cellular automata",
            "U006350",
            2,
            "representation",
            [ev("U006350", "PROSE", "DIRECT_COMPLETE_MECHANICS", "A range-r rule is embedded at larger range by making farther cells irrelevant; nearby rules differ only near the enlarged neighborhood edge.", ["object_kind", "input", "law_kind", "rule_relation_constraint_function_or_probability_law", "result_kind", "parameters_and_variants"])],
            values={
        ...
        spec(
            ...
            1,
            "map",
            [ev("U006369", "FORMULA", "DIRECT_COMPLETE_MECHANICS", "After t steps the dot is at Mod[m t,n], with one-step motion by m modulo n.", MAP_FIELDS)],
            values={
        ...
        spec(
            ...
            1,
            "map",
            [ev("U006372", "FORMULA", "DIRECT_COMPLETE_MECHANICS", "After t steps the dot is at Mod[k^t,n], corresponding to multiplication by k modulo n.", MAP_FIELDS)],
            values={
        ...
        spec(
            ...
            values={
                ...
                "rule_relation_constraint_function_or_probability_law": "s[m,k] = k^m - Sum[s[d,k] for proper divisors d of m]",
        ...
        spec(
            ...
            1,
            "ca1d",
            [ev("U006379", "FORMULA", "DIRECT_COMPLETE_MECHANICS", "The t-step state is PolynomialMod[(1+x)^t z,{x^n-1,2}], fixing binary cyclic evolution.", CA_FIELDS)],
            values={
        ...
        spec(
            "rule-73 random-initial-condition ensemble",
            "U006429",
            1,
            "seed",
            [ev("U006429", "PROSE", "DIRECT_PARTIAL_MECHANICS", "Completely random initial conditions for rule 73 partition into regions whose boundaries arise from even black blocks and yield period-3 density oscillations.", SEED_FIELDS)],
            values={
                ...
                "rule_relation_constraint_function_or_probability_law": "sample a completely random initial configuration; forbidding even black blocks defines a restricted variant",
            },
            variants=[("unrestricted random seed", "produces independent regions and density period 3"), ("no-even-black-block seed class", "removes the density oscillation")],
            image_witnesses=[p + "_page_969_Picture_4.jpeg"],
        ),
        spec(
            "period-p repeating-configuration constraint for one-dimensional cellular automata",
            "U006432",
            1,
            "constraint",
            [
                ev("U006432", "PROSE", "DIRECT_PARTIAL_MECHANICS", "A period-p configuration is a model of the p-step return constraint and has a repeating-block witness of bounded length.", CONSTRAINT_FIELDS),
            ...
            values={
                ...
                "rule_relation_constraint_function_or_probability_law": "CA^p(configuration)=configuration, with compatible length-(2pr+1) local blocks",
                "result_kind": "the set of configurations repeating with period dividing p",
                "witness_semantics": "a repeating sequence of compatible blocks, with a block-length witness bounded by 2^(2pr)",
            },
        ...
        spec(
            ...
            "ca1d",
            [
                ev("U006461", "FORMULA", "DIRECT_PARTIAL_MECHANICS", "The new cell is f[a1,a2], with f associative, and the complete history is generated by the stated NestList.", CA_FIELDS),
