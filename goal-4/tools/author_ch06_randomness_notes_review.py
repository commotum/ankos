        ...
        *[
        ...
        spec(
            ...
            values={
                ...
                "parameters_and_variants": "the source fixes the injection site at the center cell and the injection cadence at every evolution step",
            },
            parameters=[
                ("injection site", "the center cell"),
                ("injection cadence", "once at every evolution step"),
            ],
        ...
        spec(
            ...
            1,
            "constraint",
            [ev("U006348", "FORMULA", "DIRECT_COMPLETE_MECHANICS", "Accepted elementary rule numbers are exactly those whose eight base-2 digits match {_, i, _, j, i, _, j, 0}.", CONSTRAINT_FIELDS + ["parameters_and_variants"])],
            values={
                ...
                "parameters_and_variants": "binary selector digits i and j are each reused at two fixed positions in the eight-bit rule pattern",
            },
            parameters=[
                ("i", "binary selector digit repeated in pattern positions 2 and 5"),
                ("j", "binary selector digit repeated in pattern positions 4 and 7"),
            ],
        ),
        spec(
        ...
        spec(
            ...
            parameters=[
                ("k", "number of cell colors in the surveyed totalistic rule space"),
                ("r", "cellular-automaton neighborhood range in the surveyed rule space"),
            ],
        ...
        spec(
            ...
            parameters=[("rule-parameter vector", "one or more smoothly varying rule parameters; the source gives neither names nor domains")],
        ...
        spec(
            ...
            parameters=[
                ("r", "range of the source cellular-automaton rule"),
                ("R", "larger target representation range, with R > r"),
            ],
        ),
        spec(
            ...
            4,
            "constraint",
            [ev("U006350", "PROSE", "DIRECT_PARTIAL_MECHANICS", "At a common enlarged range, nearby rules are defined by differences involving only cells close to the neighborhood edge.", CONSTRAINT_FIELDS + ["parameters_and_variants"])],
            values={
            ...
            parameters=[
                ("common representation range", "the enlarged range at which the two rules are compared"),
                ("edge-locality band", "the source's qualitative selection of cells close to the neighborhood edge; no numeric width is stated"),
            ],
        ...
        spec(
            ...
            [
                ev(
                    ...
                    "PROSE",
                    "DIRECT_PARTIAL_MECHANICS",
                    "Systems whose initial states contain an infinite element sequence can take that sequence at random, while a mobile head retains a definite initial location; sequential substitutions and ordinary or cyclic tag systems cannot readily take infinite random inputs, finite integer or register systems have no unique randomness definition, infinite random inputs are not meaningful for multiway systems, and constraints have no initial conditions.",
                    SEED_FIELDS + ["structural_invariants", "parameters_and_variants"],
                )
            ],
            values={
                ...
                "structural_invariants": "the construction applies only where an infinite input sequence is meaningful; mobile systems retain a definite active location, sequential substitutions and ordinary or cyclic tag systems cannot readily use infinite random inputs, finite integer or register systems have no unique randomness definition, infinite random inputs are not meaningful for multiway systems, and constraints have no initial conditions",
            ...
            variants=[
                ("random tape colors", "mobile automata and Turing machines keep a definite active-cell location", "U006360"),
                ("random substitution input", "ordinary substitution systems can consume an infinite random sequence", "U006360"),
                ("random real-number digits", "continuous-number systems expose an infinite random digit sequence", "U006360"),
                ("sequential-substitution and tag-system exclusion", "sequential substitutions and ordinary or cyclic tag systems cannot readily take infinite random initial conditions", "U006360"),
                ("finite-integer or register-system limitation", "finite digit sequences have no unique definition of randomness", "U006360"),
                ("multiway-system exclusion", "an infinite random initial condition would typically yield infinitely many possible states and is not meaningful", "U006360"),
                ("constraint-system exclusion", "constraint systems have no initial conditions", "U006360"),
            ],
        ...
        spec(
            ...
            [
                ...
                ev("U006365", "PROSE", "DIRECT_PARTIAL_MECHANICS", "The source compares two cellular-automaton evolutions through their cellwise difference pattern; for an additive rule, that difference pattern is exactly the evolution from an initial condition containing only the changes.", ["law_kind", "rule_relation_constraint_function_or_probability_law", "result_kind", "structural_invariants", "parameters_and_variants"]),
            ],
            values={
                "input": "an underlying cellular-automaton rule together with two initial conditions or histories to compare",
                "structural_invariants": "the difference-region edge can propagate no faster than r cells per step for a range-r rule; for additive rules, the difference pattern equals the evolution from the change-only initial condition",
            ...
            variants=[("additive-rule specialization", "evolve an initial condition consisting only of the changes to obtain exactly the pairwise difference pattern", "U006365")],
        ...
        spec(
            ...
            [
                ...
                ev("U006366", "PROSE", "DIRECT_PARTIAL_MECHANICS", "Additive or partially additive class-3 rules, such as rules 90 and 30, always turn an initial change into expanding differences; other rules need not, and for rule 22 a one-cell color change has no effect after one step when the changed cell has a two-black-cell block on each side.", ["input", "rule_relation_constraint_function_or_probability_law", "result_kind", "structural_invariants", "parameters_and_variants"]),
            ...
            values={
                ...
                "structural_invariants": "every change expands under additive or partially additive class-3 rules such as rules 90 and 30, while general rules can admit perturbations that die out",
            ...
            variants=[
                ...
                ("additive or partially additive class-3 rule", "every initial change leads to expanding differences", "U006366"),
        ...
        spec(
            ...
            parameters=[
                ("m", "number of cyclic positions advanced per step"),
                ("n", "total number of cyclic positions"),
            ],
        ...
        spec(
            ...
            1,
            "map",
            [ev("U006372", "FORMULA", "DIRECT_COMPLETE_MECHANICS", "After t steps the dot is at Mod[k^t,n]; coprime k,n give return period MultiplicativeOrder[k,n], powers n=k^s reach the absorbing state 0 after s steps, and in general the dot visits m=k^IntegerExponent[n,k] every MultiplicativeOrder[k,n/m] steps.", MAP_FIELDS + ["structural_invariants", "parameters_and_variants"])],
            values={
                "carrier": "n cyclic residue positions",
                "complete_state": "the current dot position",
                "structural_invariants": "when GCD[k,n]=1 the return period is MultiplicativeOrder[k,n], which divides EulerPhi[n], and position 0 is unreachable; when n=k^s, 0 is reached after s steps and is absorbing; in general m=k^IntegerExponent[n,k] is visited every MultiplicativeOrder[k,n/m] steps",
            ...
            parameters=[
                ("k", "multiplier applied before reduction modulo n", "U006372"),
                ("n", "number of cyclic residue positions", "U006372"),
            ],
            variants=[("general non-coprime orbit", "visit m=k^IntegerExponent[n,k] every MultiplicativeOrder[k,n/m] steps", "U006372")],
        ),
        spec(
            ...
            "observer",
            [
                ev("U006373", "PROSE", "DIRECT_IDENTITY", "The number s[m,k] counts k-color states of minimum spatial period m.", ["object_kind", "input", "result_kind", "parameters_and_variants"]),
            ...
            values={
                ...
                "parameters_and_variants": "minimum spatial period m and alphabet size k",
            },
            parameters=[
                ("m", "minimum spatial period to count"),
                ("k", "number of cell colors"),
            ],
        ),
        spec(
            ...
            values={
                ...
                "seed": "the initial binary state polynomial z; the source gives z=1 as the single-black-cell preset",
                ...
                "parameters_and_variants": "cyclic ring size n and initial-state polynomial z",
            },
            parameters=[
        ...
        spec(
            ...
            1,
            "ca1d",
            [ev("U006383", "PROSE", "DIRECT_PARTIAL_MECHANICS", "The rule-60 polynomial analysis is repeated with 1/x+x at each step for cyclic rule 90.", CA_FIELDS + ["seed", "parameters_and_variants"])],
            values={
                "topology": "a cyclic one-dimensional lattice of odd n cells in the stated analysis",
                "alphabet_or_value_schema": "binary coefficients modulo 2",
                "boundary": "cyclic",
                "seed": "an initial binary state polynomial z, inherited by the stated analogous polynomial analysis",
                ...
                "parameters_and_variants": "odd cyclic ring size n and initial-state polynomial z",
            },
            parameters=[
                ("n", "odd number of cells on the cyclic ring in the stated analysis"),
                ("z", "binary polynomial representing the initial state"),
            ],
        ...
        spec(
            ...
            "observer",
            [
                ev("U006386", "PROSE", "DIRECT_PARTIAL_MECHANICS", "The survey compares finite-ring repetition periods for rules 45, 30, and 60 and their conjugates/reflections as n varies; for rule 30 at n=13 the maximum period is 832 versus 260 from one black cell, while rule 45 attains the stated maximum at n=9 but apparently at no larger n.", OBS_FIELDS + ["structural_invariants", "parameters_and_variants"]),
            ...
            values={
                ...
                "structural_invariants": "rule 30 at n=13 has maximum period 832 while a single-black-cell seed has period 260; rule 45 attains the stated maximum at n=9 but apparently not for any larger n",
            ...
            parameters=[
                ("elementary rule", "one of rules 45, 30, or 60, including a selected conjugate or reflection", "U006386"),
                ("n", "finite cyclic ring size", "U006386"),
            ],
            variants=[
                ("base-rule presets", "rules 45, 30, and 60", "U006386"),
                ("symmetry variants", "the conjugates and reflections of the three base rules", "U006386"),
                ("rule 30 at n=13", "maximum period 832 versus period 260 from a single black cell", "U006386"),
                ("rule 45 at n=9 and above", "attains the stated maximum at n=9 but apparently not at any larger n", "U006386"),
            ],
            missing=["Apart from the explicit rule-30 and rule-45 exceptions, the figure's numeric series are not independently transcribed in the adjacent prose."],
        ...
        spec(
            ...
            parameters=[
                ("n", "finite bit width"),
                ("boundary mode", "outside-zero masking or cyclic-shift neighbor access"),
            ],
            variants=[
                ("outside-zero", "mask every step with BitAnd[a,2^n-1]"),
                ("cyclic", "implement neighbor access with cyclic shifts"),
            ],
        ...
        spec(
            ...
            [
                ...
                ev("U006395", "PROSE", "DIRECT_PARTIAL_MECHANICS", "Among all k^(k^(2r+1)) k-color range-r rules, exactly k^(2r+1) are additive, each summing neighborhood values modulo k using position weights.", ["object_kind", "alphabet_or_value_schema", "structural_invariants", "read_dependencies_or_neighborhood", "law_kind", "rule_relation_constraint_function_or_probability_law", "parameters_and_variants"]),
            ...
            values={
                ...
                "structural_invariants": "the eight additive elementary rules are 0, 60, 90, 102, 150, 170, 204, and 240; each is trivial or essentially equivalent to rule 90 or 150; exactly k^(2r+1) of all k^(k^(2r+1)) k-color range-r rules are additive",
        ...
        spec(
            ...
            [
                ...
                ev("U006406", "PROSE", "DIRECT_PARTIAL_MECHANICS", "Any initial-condition history can be reconstructed under ⊕ by combining Green-function histories from basic initial conditions; the familiar construction requires ⊕ to be associative, commutative, and to have an identity, making a commutative monoid.", ["structural_invariants", "rule_relation_constraint_function_or_probability_law", "result_kind"]),
                ...
                ev("U006411", "PROSE", "DIRECT_PARTIAL_MECHANICS", "The basic local rules have the form RotateLeft[a] ⊕ RotateRight[a]; endomorphisms sigma act as position weights, multi-cell rules combine repeated flattened instances of ⊕, and the resulting associative-rule patterns are at most nested.", ["read_dependencies_or_neighborhood", "rule_relation_constraint_function_or_probability_law", "structural_invariants", "parameters_and_variants"]),
            ],
            values={
                "structural_invariants": "⊕ is associative, commutative, and has an identity element; arbitrary histories are reconstructed by combining basic Green-function histories under ⊕; the resulting patterns are at most nested",
            ...
            variants=[
                ...
                ("two-cell rule-90 analog", "RotateLeft[a] ⊕ RotateRight[a]", "U006411"),
                ("multi-cell flattened rule", "apply position endomorphisms sigma as weights and combine several cells through repeated flattened ⊕", "U006411"),
            ],
            image_witnesses=[
        ...
        spec(
            ...
            2,
            "map",
            [ev("U006413", "PROSE", "DIRECT_PARTIAL_MECHANICS", "For states that are continuous functions of position, a continuous local linear mapping must be a linear differential operator involving Derivative[n].", MAP_FIELDS + ["parameters_and_variants"])],
            values={
                ...
                "parameters_and_variants": "derivative orders n and the coefficients of the local linear differential operator, neither fixed by the source",
            },
            parameters=[
                ("derivative orders n", "orders of the Derivative[n] terms included in the operator; the source gives no finite list"),
                ("linear-operator coefficients", "coefficients multiplying the derivative terms; the source leaves them unspecified"),
            ],
        ...
        spec(
            ...
            [
                ...
                ev("U006418", "PROSE", "DIRECT_PARTIAL_MECHANICS", "Rule 22 gives one-step map 3p(1-p)^2 with nonzero stable estimate 1-1/Sqrt[3] approximately 0.42 versus actual density 0.35095; the two-step map p(1-p)^2(2+3p^2) yields 0.35012, and the three-step map p(1-p)^2(p^4-18p^3+41p^2-22p+6) yields 0.379.", ["native_time", "structural_invariants", "rule_relation_constraint_function_or_probability_law", "determinism_branching_or_measure", "parameters_and_variants", "result_kind"]),
                ...
                ev("U006423", "PROSE", "DIRECT_PARTIAL_MECHANICS", "Probabilistic estimates can also target difference-pattern growth rates, but correlation buildup usually prevents systematic improvement of such approximations.", ["structural_invariants", "result_kind", "parameters_and_variants"]),
            ],
            values={
                "native_time": "discrete iterations of the density approximation",
                "input": "current density p and elementary rule number m",
                "structural_invariants": "for rule 22, the one-step nonzero stable estimate is 1-1/Sqrt[3] approximately 0.42 versus actual 0.35095; the two-step estimate is 0.35012 and the three-step estimate is 0.379; correlation buildup usually prevents systematic improvement of probabilistic approximations",
                ...
                "parameters_and_variants": "rule code m, current density p, and approximation order; explicit one-, two-, and three-step variants are stated for rule 22, and exact one-step variants are stated for rules 90 and 30",
            },
            ...
            variants=[
                ...
                ("rule 22 one-step", "map 3p(1-p)^2; nonzero stable estimate 1-1/Sqrt[3] approximately 0.42 versus actual density 0.35095", "U006418"),
                ("rule 22 two-step", "map p(1-p)^2(2+3p^2), yielding density estimate 0.35012", "U006418"),
                ("rule 22 three-step", "map p(1-p)^2(p^4-18p^3+41p^2-22p+6), yielding density estimate 0.379", "U006418"),
                ...
                ("difference-pattern growth estimate", "probabilistic estimates can target growth rates, but correlation buildup usually prevents systematic improvement", "U006423"),
            ],
        ...
        spec(
            ...
            "observer",
            [
                ev("U006424", "PROSE", "DIRECT_IDENTITY", "An exact density-after-t function for rule 90 is introduced.", ["object_kind", "input", "result_kind", "parameters_and_variants"]),
            ...
            values={
                ...
                "parameters_and_variants": "initial density p and discrete step t",
            },
            parameters=[
                ("p", "initial black-cell density"),
                ("t", "discrete rule-90 evolution step"),
            ],
            status="DEFECTIVE",
        ...
        spec(
            ...
            parameters=[
                ("cellular-automaton rule", "the selected rule whose density response is measured"),
                ("p", "initial black-cell density, swept across the raster"),
                ("t", "successive evolution step, bounded by the chosen display horizon"),
            ],
            variants=[
                ("rule 236", "the displayed class-2 density-response raster"),
                ("rule 126", "a displayed class-3 density-response raster"),
                ("rule 30", "a displayed class-3 density-response raster"),
            ],
        ...
        spec(
            ...
            [
                ...
                ev("U006439", "PROSE", "DIRECT_PARTIAL_MECHANICS", "For a non-one-sided-additive rule, inspect all blocks of length 2pr+1 whose center returns after p steps and concatenate compatible blocks; this constructs p-return configurations and needs a lower-period exclusion for strict exactness. For rule 18 at p=2, 20 of 32 length-5 blocks return, and compatible configurations reduce to repetitions {a,b,0,0}, with each of a and b either {1} or {0,1}.", ["input", "rule_relation_constraint_function_or_probability_law", "result_kind", "witness_semantics", "parameters_and_variants"]),
            ],
            values={
                ...
                "parameters_and_variants": "strict exact period p is distinguished from periods merely dividing p; the source gives a rule-18 p=2 local-block specialization",
            },
            parameters=[
            ...
            variants=[
                ("rule 18 at p=2", "20 of 32 length-5 blocks return; compatible configurations are repetitions {a,b,0,0}, with a and b each independently either {1} or {0,1}", "U006439"),
            ],
        ...
        spec(
            ...
            parameters=[
                ("two-dimensional cellular-automaton rule", "the target rule whose repeating configurations are constrained"),
                ("p", "requested temporal return period"),
            ],
        ...
        spec(
            ...
            values={
                ...
                "parameters_and_variants": "antecedent period m and consequent period n",
            },
            parameters=[
                ("m", "period whose existence supplies the implication antecedent"),
                ("n", "period whose forced existence is queried"),
            ],
        ),
        spec(
            ...
            [
                ...
                ev("U006450", "PROSE", "DIRECT_PARTIAL_MECHANICS", "For cellular automata, blocking only rarely yields a cellular automaton with the same rule type, generally remains insufficient even after averaging, and a direct renormalization-group analog is useful only for fairly simple nested behavior.", ["structural_invariants", "result_kind", "parameters_and_variants"]),
            ],
            values={
                "input": "a lattice rule or weighted configuration ensemble and a block scale",
                "structural_invariants": "for cellular automata, blocking only rarely preserves the original rule type, generally fails to do so even after averaging, and a direct renormalization-group analog is useful only for fairly simple nested behavior",
                ...
                "parameters_and_variants": "block scale, blocking map, and the resulting scale-dependent effective parameters; the direct cellular-automaton analog has the stated narrow applicability",
            },
            parameters=[
                ("block scale", "size of each lattice block replaced by one effective element"),
                ("blocking map", "rule used to replace a block by an effective element; the source leaves its kernel unspecified"),
                ("effective couplings", "scale-dependent parameters describing the coarse-grained configuration weights"),
            ],
            variants=[
                ("cellular-automaton direct analog", "rarely preserves the original rule type, generally remains insufficient after averaging, and is useful only for fairly simple nested behavior", "U006450"),
            ],
        ...
        spec(
            ...
            values={
                "input": "a modulo-k additive cellular-automaton rule or weight specification together with its history",
            ...
            parameters=[
                ("k", "prime modulus and spatial/temporal rescaling factor"),
                ("additive rule", "the target modulo-k additive rule or its weight specification"),
            ],
            variants=[
                ("prime modulus", "strict invariance after retaining every kth row and column"),
                ("composite modulus", "a superposition of factor-scale patterns rather than strict invariance"),
            ],
        ),
        spec(
        ...
        spec(
            ...
            "ca1d",
            [
                ev("U006461", "FORMULA", "DIRECT_PARTIAL_MECHANICS", "The new cell is f[a1,a2], with f associative; from one nonwhite cell the resulting pattern is always nested and is essentially an additive-rule pattern with no more than k colors.", ["object_kind", "seed", "alphabet_or_value_schema", "read_dependencies_or_neighborhood", "law_kind", "rule_relation_constraint_function_or_probability_law", "structural_invariants", "parameters_and_variants"]),
                ...
                ev("U006468", "PROSE", "CORROBORATING", "Associative and commutative f yields nested behavior for multiple nonzero initial elements; noncommutative f can yield non-nested patterns, but a single initial element explores only a cyclic subgroup even for an almost arbitrary semigroup operation.", ["seed", "structural_invariants", "parameters_and_variants"]),
                ev("U006411", "PROSE", "CORROBORATING", "Within the generalized-additive commutative-monoid subclass, repeated applications of the associative operation flatten and the resulting patterns are at most nested.", ["structural_invariants", "parameters_and_variants"]),
            ],
            values={
                ...
                "structural_invariants": "f is associative; a singleton nonwhite seed always yields a nested pattern essentially equivalent to an additive-rule pattern with at most k colors, and explores only a cyclic subgroup even when f is an almost arbitrary semigroup operation; commutativity and identity are optional stated variants",
            ...
            variants=[
                ...
                ("singleton nonwhite seed", "always yields a nested pattern essentially matching an additive rule with k or fewer colors", "U006461"),
                ("single-seed semigroup reachability", "only a cyclic subgroup is explored even when f is an almost arbitrary semigroup operation", "U006468"),
                ("generalized-additive commutative-monoid subclass", "repeated applications of ⊕ flatten, and the resulting patterns are at most nested", "U006411"),
            ],
            related=["generalized-additive monoid cellular automaton family"],
        ),
        spec(
        ...
        spec(
            ...
            parameters=[
                ("rule selection", "all 256 elementary cellular-automaton rules in the stated survey"),
                ("t", "observation horizon or number of evolution steps; described only as a large number"),
            ],
        ...
        spec(
            ...
            "constraint",
            [
                ev("U006475", "PROSE", "DIRECT_PARTIAL_MECHANICS", "A finite labeled transition network represents allowed value sequences by paths.", ["object_kind", "carrier", "alphabet_or_value_schema", "complete_state", "input", "law_kind", "result_kind", "parameters_and_variants"]),
                ...
                ev("U006477", "PROSE", "DIRECT_PARTIAL_MECHANICS", "A list is accepted when it labels a path beginning at at least one network node.", ["input", "result_kind", "witness_semantics", "parameters_and_variants"]),
            ...
            values={
                ...
                "input": "a finite labeled transition network net and a finite input sequence of labels",
        ...
        spec(
            ...
            [
                ...
                ev("U006488", "PROSE", "DIRECT_PARTIAL_MECHANICS", "The ordinary MinNet result accepts each allowed value sequence along a path starting from node 1, unlike the main-text any-start-node convention.", ["result_kind", "structural_invariants", "parameters_and_variants"]),
            ...
            values={
                ...
                "result_kind": "an equivalent minimal deterministic finite automaton whose allowed value sequences are recognized along paths starting from node 1",
                "structural_invariants": "the ordinary MinNet convention fixes node 1 as the path start; a q-node source can yield as many as 2^q-1 determinized states; Myhill–Nerode guarantees a unique minimal DFA; for k=2 the source lists counts 3, 7, 78, 1388, ... by result-node count n and says (n+1)^(n k) overcounts",
        ...
        spec(
            ...
            "representation",
            [
                ev("U006488", "PROSE", "DIRECT_PARTIAL_MECHANICS", "The main-text network convention permits allowed paths to start at any node, contrasting with MinNet's node-1 start and motivating the trimmed-network transform.", ["input", "result_kind", "structural_invariants", "parameters_and_variants"]),
                ev("U006489", "CODE", "DIRECT_COMPLETE_MECHANICS", "TrimNet intersects forward-reachable node sets and renumbers the surviving subnetwork so paths may start at any retained node.", ["object_kind", "input", "law_kind", "rule_relation_constraint_function_or_probability_law", "result_kind", "parameters_and_variants"]),
            ],
            values={
                "input": "a finite labeled sequence network",
                "structural_invariants": "unlike ordinary MinNet's node-1 acceptance convention, the trimmed result implements the main-text convention in which allowed paths may start at any node",
                ...
                "parameters_and_variants": "the input network net is the sole source-code operand; no independent tuning parameter is stated",
            },
            parameters=[("net", "finite labeled sequence network supplied as the transform input", "U006489")],
            aliases=["TrimNet"],
            related=["deterministic finite-automaton minimizer"],
        ),
        spec(
            "regular language",
            "U006492",
        ...
        spec(
            ...
            "constraint",
            [
                ev("U006495", "PROSE", "CORROBORATING", "For the k=2, r=2 totalistic rule with code 20 after one image step, the shortest excluded block has length 36; this is an excluded-block scale witness and does not by itself assert that the full excluded set is finite.", ["input", "structural_invariants", "parameters_and_variants"]),
                ev("U006496", "PROSE", "DIRECT_COMPLETE_MECHANICS", "A finite-complement language is characterized by excluding a finite set of finite blocks. For an n-node sequence network, any excluded block has a shortest example of length less than n; if there are infinitely many excluded blocks, another occurs at a length from n through 2n. The source also gives rule-126 and rule-54 excluded-length examples and a one-step decrease bound of at most 2r.", CONSTRAINT_FIELDS + ["structural_invariants", "parameters_and_variants"]),
                ev("U006503", "PROSE", "CORROBORATING", "Every Perron number can be realized as the sequence-growth factor kappa of some finite-complement language.", ["structural_invariants", "result_kind", "parameters_and_variants"]),
            ],
            values={
                "carrier": "sequences over a finite alphabet",
                "input": "a sequence and a finite forbidden-block set",
                "structural_invariants": "for an n-node sequence network, if blocks are excluded then the shortest excluded block has length less than n; if infinitely many blocks are excluded then an additional excluded block has length between n and 2n; across successive cellular-automaton image steps the shortest newly excluded length can decrease by at most 2r; every Perron number is realizable as the growth factor of some finite-complement language",
                ...
                "parameters_and_variants": "finite forbidden-block set, network node count n, and cellular-automaton range r; the source supplies code-20, rule-126, and rule-54 excluded-block examples",
            },
            parameters=[
                ("n", "number of nodes in a finite sequence network used to bound excluded-block lengths", "U006496"),
                ("r", "cellular-automaton range controlling the maximum one-step decrease 2r", "U006496"),
            ],
            variants=[
                ("code 20 after one image step", "the shortest excluded block has length 36; finiteness of the full excluded set is not asserted", "U006495"),
                ("rule 126 successive image steps", "shortest newly excluded lengths 0, 3, 12, 13, 14, 14, 17, 15", "U006496"),
                ("rule 54 steps 4 to 5", "the shortest newly excluded length decreases from 9 to 7", "U006496"),
                ("Perron growth-factor realization", "every Perron number is the growth factor kappa of some finite-complement language", "U006503"),
            ],
        ...
        spec(
            ...
            [
                ...
                ev("U006505", "PROSE", "CORROBORATING", "Encoding allowed binary sequences as Sum[a_i 2^-i] produces a Cantor set whose Hausdorff dimension is exactly the spatial entropy h.", ["structural_invariants", "result_kind", "parameters_and_variants"]),
            ...
            values={
                ...
                "structural_invariants": "kappa is a Perron algebraic number; every Perron number is realizable by some finite-complement language; entropy over successive cellular-automaton image steps never increases; the Hausdorff dimension of the encoded binary sequence set equals spatial entropy h",
            ...
            variants=[
                ...
                ("binary Cantor-set encoding", "Hausdorff dimension equals spatial entropy h", "U006505"),
            ...
            related=["finite-complement language", "sequence-set to Cantor-set encoding"],
        ),
        spec(
        ...
        spec(
            ...
            "observer",
            [
                ev("U006506", "FORMULA", "DIRECT_PARTIAL_MECHANICS", "Cycle counts are traces of matrix powers.", ["object_kind", "input", "law_kind", "result_kind", "determinism_branching_or_measure", "parameters_and_variants"]),
            ...
            values={
                ...
                "parameters_and_variants": "network adjacency matrix m and formal generating-function variable x",
            },
            parameters=[
                ("m", "finite network adjacency matrix"),
                ("x", "formal variable of the cycle generating function"),
            ],
        ),
        spec(
            ...
            1,
            "constraint",
            [ev("U006511", "PROSE", "DIRECT_COMPLETE_MECHANICS", "The model set consists of n-by-n binary square grids containing no adjacent pair of black cells; its fitted entropy is h approximately 0.589, with no known exact formula.", CONSTRAINT_FIELDS + ["structural_invariants", "parameters_and_variants"])],
            values={
                "carrier": "two-dimensional n by n square grids",
                "alphabet_or_value_schema": "black and white cells",
                "input": "a finite binary square grid",
                "structural_invariants": "the asymptotic configuration-count entropy is fitted as h approximately 0.589, and the source states that no exact formula is known",
                ...
                "parameters_and_variants": "square-grid side length n",
            },
            parameters=[("n", "side length of the finite n by n square grid")],
        ),
        spec(
            ...
            2,
            "constraint",
            [ev("U006511", "PROSE", "DIRECT_IDENTITY", "The hard-hexagon lattice gas is named as a hexagonal-cell constraint model whose exact solution gives h approximately 0.481 as the logarithm of the largest root of a degree-12 polynomial.", ["object_kind", "carrier", "structural_invariants", "result_kind", "parameters_and_variants"])],
            values={
                "carrier": "a hexagonal lattice",
                "structural_invariants": "h is approximately 0.481 and is the logarithm of the largest root of a degree-12 polynomial",
                "result_kind": "the model's allowed configurations",
                "parameters_and_variants": "a finite model extent is required for finite approximants, but the unit gives no size or boundary convention",
            },
            parameters=[("model extent", "finite approximation size governing an entropy limit; the source does not specify its shape, units, or boundary")],
            missing=["The occupancy alphabet, adjacency exclusion rule, finite-size convention, and boundary convention are not stated in the unit."],
        ),
        spec(
            ...
            3,
            "constraint",
            [ev("U006511", "PROSE", "DIRECT_COMPLETE_MECHANICS", "Accepted configurations are complete coverings of a square grid by two-cell dominoes, with entropy h=Catalan/(pi Log[2]) approximately 0.421.", CONSTRAINT_FIELDS + ["structural_invariants", "parameters_and_variants"])],
            values={
                "carrier": "a square grid",
                "input": "a placement of two-cell dominoes",
                "structural_invariants": "the complete-covering entropy is h=Catalan/(pi Log[2]) approximately 0.421",
                ...
                "parameters_and_variants": "square-grid extent, whose finite dimensions and boundary convention are not fixed in the unit",
            },
            parameters=[("grid extent", "dimensions of the square-grid region to cover; the source gives no fixed size or boundary convention")],
            aliases=["dimer problem"],
            missing=["The finite grid dimensions and boundary convention are not stated in the unit."],
        ),
        spec(
        ...
        spec(
            ...
            "observer",
            [
                ev("U006514", "FORMULA", "DEFECT_LIMITED", "The extraction prints Limit[Sum[UnitStep[p[i]],{i,k^n}]/n,n->Infinity], which counts supported blocks but omits the logarithm needed for a finite exponential growth rate.", OBS_FIELDS + ["parameters_and_variants"]),
            ...
            values={
                ...
                "parameters_and_variants": "alphabet size k and block length n; the quantity is also named capacity and fractal dimension in the source",
            },
            parameters=[("k", "alphabet size"), ("n", "block length sent to infinity")],
        ...
        spec(
            ...
            3,
            "constraint",
            [ev("U006518", "PROSE", "DIRECT_PARTIAL_MECHANICS", "Surjectivity asks whether every possible input state also occurs as output; the stated test constructs the minimal finite automaton.", CONSTRAINT_FIELDS + ["parameters_and_variants"])],
            values={
                "input": "a cellular-automaton rule",
        ...
        spec(
            ...
            [
                ...
                ev("U006526", "PROSE", "DIRECT_PARTIAL_MECHANICS", "The source states h_t <= h_tx <= 2 lambda h_x and h <= 2r h_t; for additive rules 90 and 150 every initial block gives a distinct patch, so h_tx=2r=2.", ["structural_invariants", "result_kind", "parameters_and_variants"]),
                ev("U006529", "PROSE", "DIRECT_PARTIAL_MECHANICS", "Spacetime entropy is also called invariant entropy and is invariant under continuous invertible transformations of symbol sequences, whereas the spatial and temporal entropies are not.", ["structural_invariants", "result_kind", "parameters_and_variants"]),
            ],
            values={
                "input": "counts s[t,x] of possible cellular-automaton spacetime patches",
                "structural_invariants": "h_t <= h_tx <= 2 lambda h_x and h <= 2r h_t; for additive rules 90 and 150, h_tx=2r=2; h_tx is invariant under continuous invertible symbol-sequence transformations, unlike spatial and temporal entropy",
            ...
            parameters=[
                ("k", "alphabet size", "U006524"),
                ("r", "cellular-automaton range", "U006524"),
                ("x", "patch width", "U006524"),
                ("t", "patch height", "U006524"),
                ("cellular-automaton rule", "rule whose possible spacetime patches are counted", "U006526"),
            ],
            variants=[
                ("additive rule 90", "h_tx=2r=2 because distinct initial blocks yield distinct patches", "U006526"),
                ("additive rule 150", "h_tx=2r=2 because distinct initial blocks yield distinct patches", "U006526"),
            ],
        ),
        spec(
            ...
            [
                ...
                ev("U006526", "PROSE", "DIRECT_PARTIAL_MECHANICS", "Measure spacetime entropy replaces patch counts by the probability-weighted p Log p expression. The source reports h_tx^mu<1.155 for rule 30, with some evidence the true value may be 1; h_tx^mu appears to equal 1 for rule 18; and the upper bounds are 0.915 for rule 22 and 0.25 for rule 54.", OBS_FIELDS + ["structural_invariants", "parameters_and_variants"]),
            ],
            values={
                "input": "probabilities of x-by-t cellular-automaton spacetime patches for alphabet size k and range r",
                "structural_invariants": "source-reported cases are rule 30 h_tx^mu<1.155 with some evidence for a true value of 1, rule 18 apparently h_tx^mu=1, rule 22 h_tx^mu<0.915, and rule 54 h_tx^mu<0.25",
            ...
            parameters=[
                ...
                ("x", "patch width", "U006524"),
                ("t", "patch height", "U006524"),
                ("cellular-automaton rule", "rule whose spacetime-patch probability distribution is analyzed", "U006526"),
            ],
            variants=[
                ("rule 30", "h_tx^mu<1.155, with some evidence that the true value may be 1", "U006526"),
                ("rule 18", "h_tx^mu appears to equal 1", "U006526"),
                ("rule 22", "h_tx^mu<0.915", "U006526"),
                ("rule 54", "h_tx^mu<0.25", "U006526"),
            ],
        ...
        spec(
            ...
            [
                ...
                ev("U006546", "PROSE", "DIRECT_PARTIAL_MECHANICS", "Shift symmetry produces repeated isomorphic graph pieces whose count divides the finite system size n; reflection and color symmetries likewise produce identical pieces corresponding to symmetry cosets.", ["structural_invariants", "parameters_and_variants"]),
                ev("U006552", "PROSE", "DIRECT_PARTIAL_MECHANICS", "Finite additive-CA graphs have cycle lengths dividing the longest cycle and identical rooted structures at every cycle state. Odd n gives a single-arc rooted structure and half the states on cycles; even n gives the stated rule-60 and rule-90 tree depths and degrees; the on-cycle fraction is 2^(-2^IntegerExponent[n,2]); single-black states lie on longest cycles and all-white is a length-1 cycle.", ["structural_invariants", "parameters_and_variants"]),
            ],
            values={
                "input": "a deterministic system with finitely many complete states",
                "structural_invariants": "every node has exactly one outgoing arc; every component contains one recurrent cycle with possible transient trees; shift symmetry produces repeated isomorphic pieces whose count divides n, and reflection or color symmetries produce symmetry cosets; for finite rule-60 and rule-90 graphs, odd n gives a single-arc rooted structure and half the states on cycles, while the general on-cycle fraction is 2^(-2^IntegerExponent[n,2]); single-black states are always on longest cycles and all-white is a length-1 cycle",
            ...
            variants=[
                ...
                ("shift-symmetry pieces", "the number of identical shifted graph pieces divides system size n", "U006546"),
                ("rules 60 and 90 at odd n", "each cycle state has a single-arc rooted structure and half of all states lie on cycles", "U006552"),
                ("rule 60 at even n", "balanced rooted trees have depth 2^IntegerExponent[n,2] and degree 2", "U006552"),
                ("rule 90 at even n", "balanced rooted trees have depth 2^IntegerExponent[n/2,2] and degree 4", "U006552"),
                ("additive-rule cycle fraction and special states", "on-cycle fraction 2^(-2^IntegerExponent[n,2]); single-black states lie on longest cycles and all-white is a length-1 cycle", "U006552"),
            ],
            image_witnesses=[
        ...
        spec(
            ...
            [
                ...
                ev(
                    ...
                    "PROSE",
                    "DIRECT_PARTIAL_MECHANICS",
                    "For the source's special randomness-producing rule-22 seeds, the evolved pattern has density about 0.35, its center is never black on two successive steps, white follows white about twice as often as black follows white, and repetitive regions occur on both sides of the random middle.",
                    ["input", "rule_relation_constraint_function_or_probability_law", "result_kind", "parameters_and_variants", "excluded_observers_and_representations"],
                ),
            ],
            values={
                "input": "a selected cellular-automaton rule, an evolved random-initial-condition history or the stated special rule-22 seed history, and a selected density or local-pattern statistic",
            ...
            variants=[
                ...
                ("rule-22 special-seed statistics", "density about 0.35; center never black on successive steps; white follows white about twice as often as black follows white; repetitive side regions", "U006390"),
            ],
