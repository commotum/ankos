...
During Stages 1–18, enforce artifact-level blind discovery: use provisional B#### candidates and do not add T-ID mappings or API-fit decisions. Start from ref/A-New-Kind-of-Science/Contents.md and read the linked 29 book documents in canonical order, pair every chapter with its Notes, inspect governed images and captions, record every relevant cross-reference, and run recursive search saturation only after reading. The canonical document set controls provenance; the Index is a discovery/checklist aid, not mechanics evidence by itself.
