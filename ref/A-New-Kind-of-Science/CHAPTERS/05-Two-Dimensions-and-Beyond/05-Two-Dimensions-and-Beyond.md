...
![](images/_page_202_Rule_Strip.jpeg)
...
The general idea of building up patterns by repeatedly applying geometrical rules is at the heart of so-called fractal geometry. And the pictures on the facing page show several more examples of fractal patterns produced in this way.
...
```text
{{1, 1} → {{{1, 2}, {1, 2}}, {}}, {1, 2} → {{2, 2}, {{1}, {1}}}, {2, 1} → {{1}, {{}, {2}}}, {2, 2} → {{1, 2}, {2, 1}}, {2, 3} → {{{2, 1}, {2}}, {1}}, {2, 4} → {{1}, {1, 1}}}
```

*(e)*

```text
{{1, 1} → {{}, {{1, 1}, {1, 2}}}, {1, 2} → {{{}, {1}}, {{1, 1}, {1, 2}}}, {2, 1} → {{2}, {}}, {2, 2} → {{{2, 1}, {1}}, {{1, 1}, {2}}}, {2, 3} → {{2, 2}, {2}}, {2, 4} → {{2, 1}, {2}}}
```
...
Examples of simple multiway systems. The number of distinct sequences at step $t$ in these three systems is respectively $\operatorname{Ceiling}[t/2]$, $t$ and $\operatorname{Fibonacci}[t+1]$ (which increases approximately like $1.618^t$).
...
The collections of states generated on successive steps by a simple multiway system with rapid growth shown on page 205. The particular rule used here eventually generates all states beginning with a white cell. At step $t$ there are $\operatorname{Fibonacci}[t+1]$ states; a given state with $m$ white cells and $n$ black cells appears at step $2m+n-1$.
...
![](images/_page_234_Template_Strip.jpeg)
