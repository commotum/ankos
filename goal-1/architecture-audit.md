...
| D128 / T22 | 264-line source closure; 95-asset candidate closure at 68 governed + 27 adjacency-only; source-pinned 512/140/102/18/10/9 general-orbit/compact/restricted RULE counts; 1,418 independent native/generic commutations; 4,608 Book/ENU context cases, 512 table-basis permutation cases, C4/D4 orbit closures, and all 19,683 ternary contexts/fibers | 1/2/3 | D127 fixed-square-grid CA preset + T02 complete local maps + T03 factorized RULE representations + T08 configurations | exactly one declared Self plus eight ordered Moore offsets; complete coordinate-basis/table permutation; compact and group-orbit fibers factor only qualifying exhaustive maps; quotient reads preserve slot multiplicity; printed `3702` provenance maps to canonical totalistic `630`; Life `224` is the `B3/S23` named preset; finite-`k,d` table formula and predicate-count distinction are validated | Add Moore access/case/restriction presets, factor/orbit maps, codecs/provenance, and named fixtures only; no stage reopens and no state class, new UPDATE, executor, family branch, Life/symmetry family, hidden center/boundary, or raster semantics is added |
