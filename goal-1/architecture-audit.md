...
| UPDATE specification | Introduce one typed UPDATE axis for snapshot finite writes, ordered replacement, structural replacement, graph replacement, bag combination, and successor-set lift; representation-specific operations such as T39 survivor-list removal must lower through explicit commuting maps rather than become family laws |
