...
- Execution status at this sync is Foundation and T01/T02/T09/T12/T13/T16/T17/T19/T20/T27/T29/T30/T31/T34/T37/T39/T41/T43/T44/T45 complete, 20 of 45 type stages complete, T03 reopened for asset-scope repair, T04 Three-Color Totalistic Cellular Automata in progress, and Synthesis and Goal 2 Handoff pending.
...
- T03's core aggregate semantics, definition/formula excerpts, official-source repairs, and strict code-777 raster remain valid. Its former 16-query/118-candidate closure and `37/10/2` asset superset are withdrawn: T04 follow-through exposed omitted named-code text/profile routes plus code-357/code-1329 and binary range-two code-20 figures, so both source and physical manifests are reopened.
...
Status: **REOPENED** in `goal-1/22-T03-TOTALISTIC-CA.md` after T04 exposed omitted named-code text/profile routes, code-357/code-1329 and code-20 assets, and related controls. Semantic conclusions remain valid; source/asset manifests, counts/oracles, global summaries, and review require repair.
...
REOPENED during T04: later named-code routes exposed omitted text/profile passages, direct code-357/code-1329 figures, binary range-two code-20 figures, and related adjacency controls. The semantic core below remains valid, but the former source/asset counts and completion claim are withdrawn until widened textual/physical audits, global summaries, and independent re-review pass.

The 16-query source oracle partitions all 118 candidates as `26/34/25/23/10`, matches 84 split duplicates, and closes 18 evidence groups with 65 verbatim fragments across 63 physical lines plus five transparent repairs against four official PDFs. T03 is an explicit numeric valuation `nu:A->{0,...,k-1}` followed by the exact sum of `2r+1` old reads and a complete `M=1+(k-1)(2r+1)`-row structural table. The optional Wolfram code uses sum zero as the least-significant base-`k` digit. T01/T02 fixed-lattice assignment and atomic update are reused unchanged.

All six embedded audit blocks pass: exact counts/codes and radius variation, sum-versus-histogram and permuted-valuation adversaries, injective exhaustive lowering, evolving-background/old-snapshot/bigint behavior, 37 included/ten excluded/two relation-only assets, exact code-777/code-867 trajectories, and the 946-cell strict code-777 raster. D115-D118 preserve T04/T05 presets, T06/T07 restrictions/properties, and additive/outer/weighted/histogram/higher-dimensional/continuous/emulation/observer boundaries. Independent review, global ledgers, fences, `git diff --check`, and all 102 repository tests pass; no prior stage reopened. Next: T04.
