...
Test parallel replacement of rectangular-grid tile labels by rectangular patches while keeping off-grid geometry and contextual patch choice separate.

#### Detailed Implementation Plan

Apply the common protocol, emphasizing finite tile labels, total closed patch tables, exact `Flatten2D` assembly, old-snapshot timing, newborn deferral, rendering separation, and the boundary to mixed-size shapes, free geometry, and contextual choice.
...
COMPLETE. The frozen Q00-Q29 source audit closes a 94-line query union at `67 pre-Index / 27 actual-Index`; 56 matched retained lines plus 59 governed continuations yield 115 retained lines at `26 native / 64 relation / 25 control`, with 11 exclusions, retained split closure `77 exact + 38 variants`, and zero unresolved. The 26 governed JPEGs partition `3 native / 16 relation / 7 control`, close 52 monolith/split references, 26 unique hashes, 1,838,481 bytes, and five assemblies covering 14 files, and remain `26 hash-bound / 0 transcribed / 0 pixel-replayed`. The semantic oracle proves 6,664 native/generic events, 13,915 commuting proofs, 6,659 restricted T27 bag commutations, 600 rank-one commutations, and 53 hostile rejections. Strict T26 is discrete `t+2D` over a finite nonempty rectangular tile grid: `AllOldTiles` reads Self only, a total closed `TileLabel -> uniform nonempty rectangular patch` table emits typed blocks, and old-snapshot `Flatten2D` assembly consumes every parent with newborn deferral. D132 classifies this as D019 ordered replacement parameterized from rank one to rank two and, independently, a category-3 lossless restriction of D041-D043 posed occurrence bags under an aligned uniform no-hole/no-overlap rectangular-tiling invariant. Mixed-size Other Shapes remains relation/control evidence; arbitrary free geometry remains T27; neighbor-dependent choice remains T28; white is an ordinary label; raster, scale, coordinate formulae, and fractal limits remain observers or relations. No T26 state class, UPDATE algebra, executor, family branch, callback, hidden control, padding, or raster rule is added. Oracle SHAs are source `549df7bf05804ac977985152671845e2d5ac70d3576bd2715e1e1e5e1ab9a029`, asset `b7ceda835ef6092a6993e84560fcec1253b605b795815d52736f74331758c5e3`, and semantic `0f5fb7d720ddce69a9e1bcfcdde102d9052de44f2d06575b07dcaade0f2723ee`; the frozen semantic digest is `b4fdbf272ff544cb824c0244e07240b8bb7b43967efd89ed70ef0637f9488a2a`. All oracle root/relocated/import/compile/optimized-mode/format/scope gates pass. No prior stage reopens. Next: T28.
