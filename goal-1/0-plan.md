...
COMPLETE: the exact evidence union reconciles the retained nine-family diagnostic, the 19-family/280-line core, and five governed continuations into 329 unique canonical lines with the disjoint partition `4 direct / 30 CA property relations / 128 CA seed-background-profile controls / 77 sibling SimpleProgram controls / 21 general controls / 69 actual-Index routes`. The physical-asset ledger closes 47 files at `5 included / 29 relation-only / 13 excluded`, with 94 monolith/split references, exact metadata, and zero unresolved remainder.
