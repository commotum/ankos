...
| Fallible RULE decision | 1/2 | Common fallible-axis/no-commit `Error` protocol | `AccessFailure(old_prefix, UndefinedTermReference)` or `RuleFailure(old_prefix, resolved_access, ResultOutsideCarrier)` retains ordered evaluation/provenance; no write or UPDATE commit; not native halt/default |
...
Oracle SHAs are source `df9cd5d4d52ce2e552d884c8ea12c932c3f9536c8cf35f4528fefe9f3768a410`, asset `95a45d1d079309a0b56fff8411be3cae66aaf31fdd38d49411a62c50f5b887e2`, and semantic `d9a1a0c71d3c29f0fffa2923d92c0abca2b663bcbc888b60d62db61018790e65`; semantic digest is `85da6b7528bd2975727daab8b7eedc5c18a9e521b9064bf2a1afc2e83acf494c`. Root/relocated/import/compile/optimized/bad-usage, cross-interface, mutation, mode, Markdown, diff, scope, repository-test, and independent hostile-review gates pass. No prior stage reopens. Next: T40.
