...
The evidence/search closure and conformance fixtures remain valid. T41 remains non-transition, while function forms and pure queries have been consolidated under generic closed-function and query/result records.
...
- Page 162 must be split by clause. T41 owns each source function, exact zero families, crossing/touch classification, and interval-count query. T40 owns the pure continued-fraction expansion/coefficient query. T42 consumes finalized coefficients or a declared coefficient source and owns the black/white word, per-step rule selection, substitutions, nested state, and generated trace.
...
- **T40/T42 continued-fraction composition:** T40 owns expansion/coefficient queries over an exact value; T42 consumes finalized coefficients or an explicit schedule source and owns the symbol sequence, rule schedule, word states, and trace. T41 owns source functions and root/count queries.
