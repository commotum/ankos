...
```text
Z(0)   = -1.460354508809586812889...
Z(50)  = -0.3407350059550249827533...
Z(100) =  2.692697056664463474995...
Z(250) = -0.9186334183561524270454...
Z(500) =  1.472447851055085272664...
```

- There are exactly 108 positive critical-line zeros `<=250` and 269 `<=500` under the named Riemann-Siegel convention. Zero 269 is `498.5807824296865420...`; zero 270 is `500.3090849416904955...`.
