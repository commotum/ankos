...
|---|---|---|---|
| Support/topology | Fixed fields, one scalar slot, ordered sequences, named banks, rooted trees, affine bags, rooted graphs, exact word sets, and declarative model sets over total lattice fields are members | PROVISIONAL lattice/scalar/sequence/bank/tree/bag/graph/word-set/model-set members; continuous/general topology UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T31, T34 |
| Values/alphabet | Explicit finite values; epsilon words; exact naturals/signed integers/reduced rationals; pattern/geometry/graph values; exact unweighted sets; symbol-keyed neighbor histograms and periodic fields | PROVISIONAL finite/infinite discrete, exact numeric, affine/point, graph-reference, set-lifted, and constraint values; other continuous/function values UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T31, T34 |
| Control | `SingleControl(key,position,payload)` in visible Markov state over a typed address domain; unit payload for T09/T19, finite head-state payload for T12 | PROVISIONAL single-control member; multiple/structural control UNRESOLVED | T09, T12, T19; absent T01/T13/T16/T17/T20/T27/T29-parallel/T30/T31/T34 |
| Active loci | Firing/source selectors include sites, a unique scalar, control loci, ordered/bag occurrences, network nodes, program-coupled flat/tree matches, queue prefixes, instructions, and every literal match across every word in a layer | PROVISIONAL fixed/scalar/control/sequence/bag/graph/interval/queue/code/tree/multiway-match sources | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T34 |
| Reads/access | Ordered topology values, the complete current scalar, control payload, self values, spans/prefixes, operands, tree bindings, geometric poses, graph path/signatures, or exact matched parent intervals; read and mutation coverage may differ | PROVISIONAL for fixed/scalar/control/word/bank/tree/bag/graph/multiway profiles | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T34 |
| Rule choice | Total tables/morphisms, ordered rewrite programs, closed instructions/templates/ASTs, topology tables, unordered finite literal relations, or closed constant arithmetic operations; no implicit defaults/callbacks | PROVISIONAL local/scalar/control/morphism/rewrite/queue/register/tree/geometric/graph/multiway programs; broader calculations UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T34 |
| Rule result | Typed members include assignment/control effects, scalar assignments, word/queue/tree/bag/graph replacements, instruction branches, and one literal interval replacement per multiway witness | PROVISIONAL result sum; never a universal category | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T34 |
| Commit/update | Explicit siblings: fixed effects, ordered replacement, one splice, queue edit, prefix-free tree replacement, bag replacement, rooted graph reroute/create/project, and exact multiway branch union | PROVISIONAL eight-member transition family; T34 reuses fixed typed assignment without a ninth; T31 is categorically outside; derivatives remain distinct | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T34; not applicable T31 |
| Successors | Execution may yield one advanced successor—including a complete set-valued macro successor—typed quiescence/reference stutter, or retained zero-successor terminal outcome | PROVISIONAL transition outcomes; exact scalar T34 always advances per valid event; T31 model/query results are distinct; derivatives UNRESOLVED | T01, T12, T16, T17, T19, T20, T27, T29, T30, T34; distinct T31 |
| Halting/invalidity | Base continuation, terminal/no-match/prefix outcomes, quiescence, explicit exit, all-dead-to-empty advancement, empty-layer stutter, observers, projection, validation, resource, and rendering cutoffs are distinct | PROVISIONAL outcome model; T34 completion/resource outcomes and native nonhalting are explicit; other construction invalidity UNRESOLVED | T12, T16, T17, T19, T20, T27, T29, T30, T34 |
| Trace encoding | Transition snapshots/events remain distinct from verified models, constraint query records/certificates, solver diagnostics, and downstream renderings | PROVISIONAL fixed/ordered/bank/tree/geometry/graph/multiway/exact-scalar traces plus explicit non-trace constraint records; global schema UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T31, T34 |
...
| Solver/numerics | Exact numeric evaluation is semantic where declared; approximate domains carry full context; constraint solvers use separate scoped results/certificates; fast-forward evaluators and renderers never replace requested exact traces | PROVISIONAL exact/declared numeric, evaluator, and solver-result boundaries | T27, T31, T34 |
...
2. The source/read/result/update protocol remains substantive through T30 and T34 but explicitly does not cover T31. T34 shows that a nonspatial `UniqueScalar` can reuse typed assignment without preserving the dense/finite runtime. Constraint specifications, model representations, verifiers, query outcomes, certificates, and solvers form a separate category; derivatives and distributions must still be independently tested.
...
6. What trace/record encoding preserves types whose semantic address is not a rank-0..3 lattice coordinate—including exact scalar snapshots/events—while keeping non-trajectory constraint records separate and big integers lossless across JSON consumers?
