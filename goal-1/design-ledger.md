...
- Consequence: T04 is the `k=3,r=1` preset and T05 the higher-color radius-one preset. T06 is the predicate `U(0)=nu^-1(0)` (equivalently `n mod k=0` in the canonical codec), while T07 reflection is derived for the equal-weight symmetric stencil. Additivity is a property/proof; seed/background choice, classes, galleries, palettes, and emulations are run/analyzer/view/relation data. Outer/semi-totalistic, histogram/count, unequal-weight/threshold, higher-dimensional, and T44 continuous aggregate-map rules require their own typed constructions rather than T03 flags.
...
- `22-T03-TOTALISTIC-CA` — COMPLETE: established totalistic CA as an explicit numeric color valuation plus fixed-arity equal-weight sum quotient and complete `M=1+(k-1)(2r+1)` structural table, with sum zero as the least-significant base-`k` digit. Exact 16/64/2,187/1,220,703,125 counts, codes 777/867/420 and radius-two code 10, equal-sum/different-histogram and non-quiescent/old-snapshot adversaries, injective T01/T02 lowering, arbitrary-precision pressure, 37 included/10 excluded/2 relation-only assets, and the exact code-777 semantic/raster oracles close the handoff. D115-D118 preserve T04/T05 preset, T06/T07 restriction, additive/property, aggregate-sibling, and observer/relation boundaries; no prior stage reopened and no executor or update law was added.
