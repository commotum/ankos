...
|---|---|---|---|
| Support/topology | Fixed regular lines/total fields, explicit discrete ordered sequences, finite named banks, and finite rooted ordered expression trees with typed head/argument paths are members | PROVISIONAL lattice, sequence, named-bank, and tree members; dynamic graph/geometric/continuous topology UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20 |
| Values/alphabet | Explicit finite field/word/atom values; independent value/control domains; epsilon-capable private words; exact infinite `Naturals`; pattern variables are typed meta-data rather than atoms | PROVISIONAL finite alphabets/words/atoms and natural-number domain; other infinite/continuous values UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20 |
| Control | `SingleControl(key,position,payload)` in visible Markov state over a typed address domain; unit payload for T09/T19, finite head-state payload for T12; the address need not belong to mutable value support | PROVISIONAL single-control member; multiple/structural control UNRESOLVED | T09, T12, T19; absent T01/T13/T16/T17/T20 |
| Active loci | Firing/source selector: `AllSites`, `ControlLocus`, `AllOccurrences`, program-coupled flat/tree match sets, program-width-coupled queue prefix, or program-address instruction; finite materialization belongs to realization | PROVISIONAL fixed/control/sequence/interval/queue/code/prefix-free-tree sources; branching sources UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20 |
| Reads/access | Explicitly ordered topology-relative values, control payload, occurrence self value, matched spans/prefixes, named operands, or matched tree plus whole-subtree bindings; read and mutation coverage may differ | PROVISIONAL for fixed lattices/single control/ordered words/named banks/expression paths | T01, T09, T12, T13, T16, T17, T19, T20 |
| Rule choice | Explicit total finite tables/morphisms, immutable ordered literal/prefix/structural-pattern programs, or a closed tagged instruction algebra; no implicit defaults/callbacks | PROVISIONAL local/control/morphism/rewrite/queue/register/tree programs; broader calculations UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20 |
| Rule result | Typed members include `Assign`, payload-bearing `TransitionControl`, ordered word/queue replacements, branch-specific instruction results, and bound subtree replacement | PROVISIONAL result sum; never a universal category | T01, T09, T12, T13, T16, T17, T19, T20 |
| Commit/update | Explicit siblings: fixed-support atomic effects, full-generation ordered replacement, exactly-one-interval splice, prefix-consume/tail-append, and prefix-free parallel subtree replacement | PROVISIONAL five-member update family; conflicts/rewire/other mutation UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20 |
| Successors | Deterministic execution may yield one advanced successor (including an applicable unchanged event), typed quiescence with reference stutter, or a retained zero-successor terminal outcome | PROVISIONAL deterministic/quiescent/terminal case; branching/solutions/derivatives remain distinct and UNRESOLVED | T01, T12, T16, T17, T19, T20 |
| Halting/invalidity | Base continuation, terminal-control, flat no-match, insufficient-prefix, past-end and tree-no-match quiescence, explicit exit, value-fixed observation, cycle, horizon, reference projection, invalidity, and error are distinct | PROVISIONAL outcome model; other construction-specific halt/invalidity UNRESOLVED | T12, T16, T17, T19, T20; no intrinsic halt T01/T09/T13 |
| Trace encoding | Structured snapshots preserve values/control/outcomes, ragged words, or ragged trees; events preserve effects/branches/paths/bindings/lineage; dense coordinates are downstream lowerings | PROVISIONAL for fixed 1D, ordered sequences, named banks, and expression trees; global schema UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20 |
...
2. Where does the T01/T09/T12/T13/T16/T17/T19/T20 source-read-result-update protocol cease to be substantive? Program-coupled flat/tree matching, queue heads, and closed instruction access remain meaningful; multiway branching, constraints, and derivatives remain adversarial.
3. Which state models require topology richer than T20's ordered tree, lineage that affects future rules rather than traces only, or control beyond a single typed address/payload? T27 geometry and T29 networks are the next direct challenges.
...
5. What trace encoding preserves types whose semantic address is not a rank-0..3 lattice coordinate? T20 establishes ragged typed paths/events before lowering but does not yet settle a universal schema.
