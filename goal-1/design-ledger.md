...
2. The source/read/result/update protocol remains substantive through T30 and the T34/T37/T39 transition profiles but explicitly does not cover T31, pure T39 filters/measurements, or T41. T41 adds immutable definitions plus scoped evaluation/zero records; T42 may consume such a record without importing evaluator or substitution state. Derivatives, distributions, and PDE solution/operator categories still require independent evidence.
...
6. What lossless record encoding preserves non-rank-0..3 semantic addresses and categories—including exact scalar/prefix/sieve transitions, constraint records, immutable function specs, and reproducible function-query results—while keeping mathematical identity, certificates, diagnostics, renderings, and big numeric values distinct across JSON consumers?
...
9. Which versioned primitive/evaluator/certificate interfaces can T41 share with later T45 while keeping denotation, algorithm, numerical context, and diagnostic work traces separate?
