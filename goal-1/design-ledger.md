...
|---|---|---|---|
| Support/topology | Fixed regular lines/total fields, explicit discrete ordered sequences, finite named banks, finite rooted ordered expression trees with typed head/argument paths, and finite affine placed-occurrence bags are members | PROVISIONAL lattice, sequence, named-bank, tree, and geometric-bag members; dynamic graph/continuous topology UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27 |
| Values/alphabet | Explicit finite field/word/atom values; independent value/control domains; epsilon-capable private words; exact infinite `Naturals`; typed pattern metadata; immutable shape prototypes; exact rational/algebraic and declared finite-precision affine values; exact algebraic extended-complex points | PROVISIONAL finite/infinite discrete and affine/point value members; other continuous/function values UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27 |
| Control | `SingleControl(key,position,payload)` in visible Markov state over a typed address domain; unit payload for T09/T19, finite head-state payload for T12; the address need not belong to mutable value support | PROVISIONAL single-control member; multiple/structural control UNRESOLVED | T09, T12, T19; absent T01/T13/T16/T17/T20/T27 |
| Active loci | Firing/source selector: `AllSites`, `ControlLocus`, ordered `AllOccurrences`, permutation-invariant `AllGeometricOccurrences`, program-coupled flat/tree match sets, program-width-coupled queue prefix, or program-address instruction; finite materialization belongs to realization | PROVISIONAL fixed/control/sequence/geometric-bag/interval/queue/code/prefix-free-tree sources; multiway sources UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27 |
| Reads/access | Explicitly ordered topology-relative values, control payload, occurrence self value, matched spans/prefixes, named operands, matched tree plus whole-subtree bindings, or a geometric occurrence's prototype/full affine pose; read and mutation coverage may differ | PROVISIONAL for fixed lattices/single control/ordered words/named banks/expression paths/geometric bags | T01, T09, T12, T13, T16, T17, T19, T20, T27 |
| Rule choice | Explicit total finite tables/morphisms, immutable ordered literal/prefix/structural-pattern programs, closed tagged instructions, total local-child affine-template rows, or closed point-map ASTs; no implicit defaults/callbacks | PROVISIONAL local/control/morphism/rewrite/queue/register/tree/geometric programs; broader calculations UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27 |
| Rule result | Typed members include `Assign`, payload-bearing `TransitionControl`, ordered word/queue replacements, branch-specific instruction results, bound subtree replacement, and occurrence replacement with composed affine children or point-map branch outputs | PROVISIONAL result sum; never a universal category | T01, T09, T12, T13, T16, T17, T19, T20, T27 |
| Commit/update | Explicit siblings: fixed-support atomic effects, full-generation ordered replacement, exactly-one-interval splice, prefix-consume/tail-append, prefix-free parallel subtree replacement, and full-generation multiplicity-preserving occurrence-bag replacement | PROVISIONAL six-member update family; conflicts/rewire/other mutation UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27 |
| Successors | Deterministic execution may yield one advanced successor (including an applicable unchanged event), typed quiescence with reference stutter, or a retained zero-successor terminal outcome; all-parent geometric expansion is one-successor even under overlap | PROVISIONAL deterministic/quiescent/terminal case; multiway/solutions/derivatives remain distinct and UNRESOLVED | T01, T12, T16, T17, T19, T20, T27 |
| Halting/invalidity | Base continuation, terminal-control, flat no-match, insufficient-prefix, past-end and tree-no-match quiescence, explicit exit, value-fixed observation, cycle, horizon, reference projection, validation/domain/numeric error, and rendering/limit cutoff are distinct | PROVISIONAL outcome model; other construction-specific halt/invalidity UNRESOLVED | T12, T16, T17, T19, T20, T27; no intrinsic halt T01/T09/T13/T27 |
| Trace encoding | Structured snapshots preserve values/control/outcomes, ragged words, ragged trees, or exact affine occurrence bags; events preserve effects/branches/paths/bindings/parent-slot lineage; dense coordinates, center lists, polygons, and rasters are downstream lowerings | PROVISIONAL for fixed 1D, ordered sequences, named banks, expression trees, and geometric bags; global schema UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27 |
...
2. Where does the T01/T09/T12/T13/T16/T17/T19/T20/T27 source-read-result-update protocol cease to be substantive? Program-coupled flat/tree matching, queue heads, closed instruction access, and permutation-invariant all-occurrence expansion remain meaningful; multiway branching, constraints, and derivatives remain adversarial.
3. Which state models require topology richer than T20's ordered tree or T27's independent affine occurrence bag, lineage that affects future rules rather than traces only, or control beyond a single typed address/payload? T29 networks are the next direct challenge.
