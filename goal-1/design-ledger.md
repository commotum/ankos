...
|---|---|---|---|
| Support/topology | Fixed fields, one scalar slot, ordered sequences and indexed numeric prefixes, ordered finite/intensional integer domains, named banks, rooted trees, affine bags, rooted graphs, exact word sets, declarative model sets over total lattice fields, and declared real/complex mathematical argument domains are members | PROVISIONAL lattice/scalar/sequence/prefix/integer-domain/bank/tree/bag/graph/word-set/model-set/function-domain members; other continuous/general topology UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T31, T34, T37, T39, T41 |
| Values/alphabet | Explicit finite values; epsilon words; exact naturals/signed integers/reduced rationals; named/algebraic/declared-precision real/complex values and enclosures; fixed numeric vectors; indexed prefixes/candidate partitions; pattern/geometry/graph values; exact sets; histograms and periodic fields | PROVISIONAL finite/infinite discrete, exact/declared numeric, function-value, prefix/filter, affine/point/vector, graph-reference, set-lifted, and constraint values | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T31, T34, T37, T39, T41 |
| Control | Visible Markov control includes `SingleControl(key,position,payload)` over typed addresses and construction-owned cursors such as the next sieve divisor; unit payload for T09/T19, finite head-state payload for T12 | PROVISIONAL single-control and explicit scalar-cursor members; multiple/structural control UNRESOLVED; absent from pure T41 definitions/queries | T09, T12, T19, T39; absent T01/T13/T16/T17/T20/T27/T29-parallel/T30/T31/T34/T37/T41 |
| Active loci | Firing/source selectors include sites, a unique scalar, the next sequence term or sieve stage, control loci, ordered/bag occurrences, network nodes, program-coupled flat/tree matches, queue prefixes, instructions, and every literal match across every word in a layer | PROVISIONAL fixed/scalar/prefix-end/stage/control/sequence/bag/graph/interval/queue/code/tree/multiway-match sources; not applicable to pure specifications/queries | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T34, T37, T39; absent T31/T41 |
| Reads/access | Ordered topology values, the complete current scalar, fixed indexed old-prefix lags, complete explicit prefix contexts, proper-multiple survivor partitions, control payload, self values, spans/prefixes, operands, tree bindings, geometric poses, graph path/signatures, or exact matched parent intervals; read and mutation coverage may differ | PROVISIONAL for transition profiles; mathematical function evaluation is a distinct pure query, not an update read | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T34, T37, T39; distinct T41 |
| Rule choice | Total tables/morphisms, ordered rewrite programs, closed instructions/templates/ASTs, topology tables, unordered finite literal relations, closed constant arithmetic, normalized fixed-lag affine programs, or closed integer predicate/measurement plus stage schedules; no implicit defaults/callbacks | PROVISIONAL transition-program members; closed mathematical expressions are definition data outside rule choice | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T34, T37, T39; distinct T41 |
| Rule result | Typed members include assignment/control effects, scalar assignments, numeric term appends, candidate-subset removals, word/queue/tree/bag/graph replacements, instruction branches, and one literal interval replacement per multiway witness | PROVISIONAL result sum; never a universal category; T41 evaluation/zero results are pure query records | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T34, T37, T39; distinct T41 |
| Commit/update | Explicit siblings: fixed effects, ordered replacement, one splice, queue edit, prefix-free tree replacement, bag replacement, rooted graph reroute/create/project, exact multiway branch union, numeric-prefix append, and monotone candidate-subset removal | PROVISIONAL ten-member transition family; T34 reuses fixed assignment, T37 adds append, T39 adds removal; T31, pure T39 specs, and T41 are categorically outside | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T34, T37, T39; not applicable T31/pure T39/T41 |
| Successors | Execution may yield one advanced successor—including a complete set-valued macro successor—typed quiescence/reference stutter, or retained zero-successor terminal outcome | PROVISIONAL transition outcomes; T31/T41 pure query results and pure T39 filter/measurement results are distinct; derivatives UNRESOLVED | T01, T12, T16, T17, T19, T20, T27, T29, T30, T34, T37, T39; distinct T31/T41 |
| Halting/invalidity | Base continuation, terminal/no-match/prefix outcomes, quiescence, explicit exit, all-dead-to-empty advancement, empty-layer stutter, observers, certificates, projection, validation, resource, and rendering cutoffs are distinct | PROVISIONAL outcome model; query completeness/partiality/resources and render horizons are not native halts | T12, T16, T17, T19, T20, T27, T29, T30, T31, T34, T37, T39, T41 |
| Trace encoding | Transition snapshots/events remain distinct from pure filter/measurement/function results, verified models, constraint/function query records/certificates, solver diagnostics, algorithm work traces, and downstream renderings | PROVISIONAL transition traces plus explicit non-trace records; global schema UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29, T30, T31, T34, T37, T39, T41 |
...
| Function/denotation | Closed mathematical expressions declare arguments, parameters, real/complex domain, scalar/fixed-vector codomain, primitive versions, partiality, and branches; point/sample/zero/crossing queries are separate | ACTIVE pure specification/query category; structural identity, certified functional equivalence, and observation equality remain distinct | T41 |
| Solver/numerics | Exact numeric evaluation is semantic where declared; approximate/certified queries carry full context; constraint/function solvers use separate scoped results/certificates; evaluators and fast-forward methods never replace requested definitions or traces | PROVISIONAL exact/declared numeric, evaluator, query-result, and solver boundaries | T27, T31, T34, T37, T39, T41 |
...
- Basis: the source explicitly factors a two-sine expression and supplies an ODE that denotes the same `Sin[x]+Sin[sqrt(2)x]` curve (`BOOK:13153-13154`). Evaluation precision and algorithms vary independently (`BOOK:19185-19187`).
- Consequence: structural IDs cover normalized tagged arguments, parameters, exact/declared values, domain/codomain, AST, primitive version, partiality, and branches. Algebraic or alternate-definition equality is a separately certified relation over a domain. Equal samples/rasters/tolerances never imply function identity. Tagged JSON preserves arbitrary integers, rationals, algebraics, decimal provenance, complex values, enclosures, and undefined reasons.
...
2. The source/read/result/update protocol remains substantive through T30, T34, and T37 but explicitly does not cover T31. T34 shows nonspatial typed assignment; T37 adds a genuine append update without preserving the dense/finite runtime. Constraint specifications, model representations, verifiers, query outcomes, certificates, and solvers form a separate category; derivatives and distributions must still be independently tested.
...
6. What trace/record encoding preserves types whose semantic address is not a rank-0..3 lattice coordinate—including exact scalar snapshots/events and reconstructible indexed-prefix traces—while keeping non-trajectory constraint records separate and big integers lossless across JSON consumers?
