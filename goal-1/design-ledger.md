...
- Consequence: after construction and validation, the unchanged branch-free FRONTIER/NEIGHBORHOOD/RULE/UPDATE runner receives `X_0`. T08 adds no state family, firing locus, read, write, UPDATE policy, executor, successor, outcome, halt, rule property, or per-step RNG. Constraint seeds, function arguments, and PDE initial traces remain their native relation/query/problem-side-data roles unless an explicit relation derives a SimpleProgram.
...
- T08 is an independent event-zero axis over the unchanged program: exact configurations, constructors, classes, laws, complete/cylinder/algorithmic realizations, validation, finite lowering, boundary/approximation, traces, and observers remain distinct. Only a complete validated `X_0` enters the runner.
- The corrected stage addenda and Goal 2 handoffs supersede the historical integration entries below. The bounded T03/T04 repairs and T06/T07/T08 are complete under active D119-D121. T10 is next.
...
- `26-T07-SYMMETRIC` — COMPLETE after hostile reclosure: the initial 357-line/22-asset manifest remains a superseded bounded diagnostic. The authoritative 650-line monolith protocol closes at `15/190/25/167/179/74`; 114 retained additions reverse-join to split material as 103 exact/11 variants without claiming a separate exhaustive split-only corpus. The final 271-asset/542-reference ledger closes at `4/38/229` with 271 unique hashes. Typed diagonal actions over exact `V_P`, generic `rho_alpha(V_P)=V_P`, support/displacement separation, six embedded checks, clean hostile review, Markdown/diff gates, and 102 tests close D120. T08 subsequently closes under D121; T10 is next.
- `27-T08-INITIAL-CONDITIONS` — COMPLETE after hostile source, asset, and architecture reclosure: the 16-query source protocol closes 1,205 query-union lines plus five governed continuations in a 1,210-entry declared audit at `701 retained / 439 duplicate-control / 70 actual-Index`; all retained lines reverse-join to split material as `634 exact / 67 variants`. The fixed-point asset universe closes 577 JPEGs/1,154 references/577 unique hashes at `366 direct / 196 relation / 15 control`. Exact configurations, deterministic constructors, configuration classes, probability laws, complete/cylinder/algorithmic realization records, validation, finite lowering relations, traces, and observers remain distinct. Only a complete validated `X_0` enters the unchanged branch-free runner; finite cylinders and decoded work observations cannot masquerade as native infinite configurations or traces. D121, the source/asset/semantic oracles, independent hostile review, Markdown/diff gates, and 102 tests pass. No prior stage reopens; T10 is next.

## Open Architecture Questions

1. Resolved CA prefix: T01 is the fixed-lattice construction; T02 parameterizes its alphabet/ordered table; T03 adds the exact numeric-sum rule quotient without a second executor; T04/T05 are presets; T06 and T07 are typed program-property restrictions; and T08 supplies independent validated event-zero configurations/classes/laws and realization records under active D119-D121. T10 is the next construction hypothesis.
