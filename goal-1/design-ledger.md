...
- `22-T03-TOTALISTIC-CA` — COMPLETE after the bounded T05 repair: the earlier code-357/code-1329/range-two-code-20 repair remains valid, and the formerly unfollowed code-`1004600` Notes continuation at `BOOK:19234` plus two linked long-run plots are now included. The exact 18-query/312-candidate closure, 22 evidence groups, 118 assets at `50/60/8`, 104-link reverse join, six embedded oracles, fresh independent review, and 102 tests pass. The semantic result—explicit valuation, fixed-arity equal-weight sum, complete `M=1+(k-1)(2r+1)` table, shared executor, and no new update law—remains active under D115-D118.
- `23-T04-THREECOLOR-TOTALISTIC` — COMPLETE: the exact 12-query audit partitions 243 candidates, closes 15 evidence groups at 253 cited provenance lines/92 quote fragments/90 quote lines, and dispositions 72 assets at 35 included/32 excluded/5 relation-only. Six embedded oracles, exact code/trajectory/property/gallery fixtures, corrected 1659/1632 labels, independent review, and 102 tests prove the strict `k=3,r=1,A=(0,1,2),nu(i)=i` preset resolves to the generic T03 structural identity and executor. D115-D118 suffice; T05/T06/T07/T08 ownership remains separate and no new executor, update law, or decision was added. T03's later T05 reopening concerns an excluded four-color observer continuation and does not alter this T04 result.
