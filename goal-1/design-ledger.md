...
|---|---|---|---|
| Support/topology | Fixed regular lines/total fields, explicit discrete ordered sequences, finite named banks, finite rooted ordered expression trees, finite affine placed-occurrence bags, and finite rooted labeled port graphs are members | PROVISIONAL lattice, sequence, named-bank, tree, geometric-bag, and rooted-graph members; continuous/general graph topology UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29 |
| Values/alphabet | Explicit finite field/word/atom values; independent value/control domains; epsilon-capable private words; exact infinite `Naturals`; typed pattern metadata; immutable shape prototypes; exact affine/complex values; alpha-renamable vertex references and finite port words | PROVISIONAL finite/infinite discrete, affine/point, and graph-reference members; other continuous/function values UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29 |
| Control | `SingleControl(key,position,payload)` in visible Markov state over a typed address domain; unit payload for T09/T19, finite head-state payload for T12; the address need not belong to mutable value support | PROVISIONAL single-control member; multiple/structural control UNRESOLVED | T09, T12, T19; absent T01/T13/T16/T17/T20/T27/T29-parallel |
| Active loci | Firing/source selector: `AllSites`, `ControlLocus`, ordered `AllOccurrences`, permutation-invariant `AllGeometricOccurrences`, `AllNetworkNodes`, program-coupled flat/tree matches, queue prefix, or program-address instruction | PROVISIONAL fixed/control/sequence/bag/graph/interval/queue/code/tree sources; multiway sources UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29 |
| Reads/access | Explicitly ordered topology-relative values, control payload, occurrence self value, matched spans/prefixes, named operands, tree bindings, geometric full pose, or old-graph port-path endpoints and exact-length reach signatures; read and mutation coverage may differ | PROVISIONAL for fixed/control/word/bank/tree/bag/rooted-graph profiles | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29 |
| Rule choice | Explicit total tables/morphisms, immutable ordered literal/prefix/structural programs, closed instructions, local affine rows/point-map ASTs, or total topology-keyed port-rewrite tables; no implicit defaults/callbacks | PROVISIONAL local/control/morphism/rewrite/queue/register/tree/geometric/graph programs; broader calculations UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29 |
| Rule result | Typed members include `Assign`, `TransitionControl`, ordered word/queue replacements, instruction branches, bound subtree replacement, geometric occurrence replacement, and two-port direct/fresh graph rewrites | PROVISIONAL result sum; never a universal category | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29 |
| Commit/update | Explicit siblings: fixed-support atomic effects, ordered full replacement, one interval splice, prefix-consume/tail-append, prefix-free tree replacement, occurrence-bag replacement, and rooted port-graph reroute/create/project | PROVISIONAL seven-member update family; multiway/conflict/other mutation UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29 |
| Successors | Deterministic execution may yield one advanced successor (including unchanged events), typed quiescence with reference stutter, or a retained zero-successor terminal outcome; graph projection remains one-successor | PROVISIONAL deterministic/quiescent/terminal case; multiway/solutions/derivatives remain distinct and UNRESOLVED | T01, T12, T16, T17, T19, T20, T27, T29 |
| Halting/invalidity | Base continuation, terminal-control, flat no-match, insufficient-prefix, past-end/tree no-match quiescence, explicit exit, fixed/cycle observations, horizon, projection, validation/domain/numeric error, resource and rendering cutoffs are distinct | PROVISIONAL outcome model; other construction-specific halt/invalidity UNRESOLVED | T12, T16, T17, T19, T20, T27, T29; no intrinsic halt T01/T09/T13/T27/T29 |
| Trace encoding | Structured snapshots preserve values/control/outcomes, ragged words/trees, exact affine bags, or rooted port graphs; events preserve effects, matches, paths, bindings, births, raw edges, projection, and lineage before downstream lowering | PROVISIONAL fixed, ordered, bank, tree, geometry, and graph traces; global schema UNRESOLVED | T01, T09, T12, T13, T16, T17, T19, T20, T27, T29 |
...
3. T29 now establishes mutable cyclic labeled topology and event-local fresh identity beyond T20 trees/T27 bags. Does T30 multiway evolution require semantic branch occurrences or only exact successor-state sets plus derivation provenance, and when are equal children merged?
