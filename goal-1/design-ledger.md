...
- Basis: Chapter 5 fixes one square grid, all-site old-snapshot parallel update, the old center, eight surrounding positions including diagonals, and codes `175850`, `746`, and `174826` (`BOOK:2212-2234`). The Notes pin the `Self + k*FullTotal` implementation, general positional order, the binary `2^512/2^140/2^102/2^18/2^10/2^9` general/symmetry/compact/restricted counts, width-ten totalistic code spelling, predicate-count variants, and Life code `224`/`B3/S23` as an ordinary nine-neighbor outer-totalistic rule (`BOOK:11178-11190,13475-13549,14239-14249,18749-18757`). The fixed points close 264 source lines at `90 native / 102 relation / 72 control`; 95 asset candidates at 68 governed plus 27 adjacency-only; and 1,418 native/generic commutations, all 262,144 outer signatures, all 1,024 equal-sum tables, C4/D4 orbit closures at 140/102 orbits, 4,608 basis contexts, 512 table-basis cases, and all 19,683 ternary Moore contexts.
