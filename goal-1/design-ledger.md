...
- `22-T03-TOTALISTIC-CA` — COMPLETE after reopening: named code-357/code-1329 and binary range-two code-20 follow-through invalidated the former 118-candidate/37-10-2 closure. The replacement 17-query/309-candidate audit closes 21 evidence groups and 116 assets at 48/60/8, with a bidirectional 102-link predicate, exact codes 10/20/52, corrected 1659/1632 labels, five official PDFs, six passing blocks, fresh independent review, and 102 tests. The semantic result remains explicit valuation plus fixed-arity equal-weight sum and a complete `M=1+(k-1)(2r+1)` table over the shared executor; D115-D118 remain active and no executor/update law was added.
- `23-T04-THREECOLOR-TOTALISTIC` — COMPLETE: the exact 12-query audit partitions 243 candidates, closes 15 evidence groups at 253 cited provenance lines/92 quote fragments/90 quote lines, and dispositions 72 assets at 35 included/32 excluded/5 relation-only. Six embedded oracles, exact code/trajectory/property/gallery fixtures, corrected 1659/1632 labels, independent review, and 102 tests prove the strict `k=3,r=1,A=(0,1,2),nu(i)=i` preset resolves to the generic T03 structural identity and executor. D115-D118 suffice; T05/T06/T07/T08 ownership remains separate, T03 is complete after repair, and no new executor, update law, or decision was added.
