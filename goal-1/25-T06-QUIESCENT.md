...
| `rules.Rule` family/ID/callable metadata | SEMANTIC MISMATCH | No inspectable alphabet, complete structural table, typed domain, or stable program reference exists; opaque callbacks cannot be certified (`src/ca/rules.py:30-33,64-78`). |
